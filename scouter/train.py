...
def get_args_parser():
    ...
    parser.add_argument("--grad_min_level", default=0.0, type=float, help="control the grad-cam vis area")
    parser.add_argument("--iterated_evaluation_num", default=1, type=int, help="used for iterated evaluation")
    parser.add_argument(
        "--cal_area_size", default=False, type=str2bool, help="whether to calculate for area size of the attention map"
    )
    parser.add_argument(
        "--thop", default=False, type=str2bool, help="whether to only calculate for the model costs (no training)"
    )
